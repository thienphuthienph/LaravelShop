                        ...
                        <div class="col-md-3">
                            <div class="card product-card">
                                <div class="product-image position-relative">
                                    ...
                                    <!--Hien thi hinh anh feature product-->
                                    @if (!empty($productImage->image))
                                        <img src="{{ asset('uploads/product/small/' . $productImage->image) }}">
                                    @endif
                                    <a class="whishlist" onclick="addToWhishlist({{ $product->id }})" href="#"><i
                                ...
                                <div class="card-body text-center mt-3">
                                    ...
                                    <div class="price mt-2">
                                        @if ($product->qty <= 0)
                                            <span class="h5"><strong>Out of stock</strong></span>
                                        @elseif ($product->compare_price > 0)
                                            <span class="h5"><strong>{{ number_format($product->price, 0) }}
                                                    VND</strong></span>

                                            <span class="h6 text-underline"><del>{{ number_format($product->compare_price, 0) }}
                                                    VND</del>
                                            </span>
                                        @else
                                        <span class="h5"><strong>{{ number_format($product->price, 0) }}
