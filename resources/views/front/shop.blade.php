                            ...
                            <div class="accordion accordion-flush" id="accordionExample">'
                                @if ($categories->isNotEmpty())
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        @endif
                                        @if ($category->sub_category->isNotEmpty())
                                        <div id="collapse{{$key}}" class="accordion-collapse collapse {{$categorySelected == $category->id ? 'show' : ''}}" aria-labelledby="heading{{$key}}" data-bs-parent="#accordionExample" style="">
                                        ...
                                        <div class="card-body text-center mt-3">
                                            ...
                                            <div class="price mt-2">
                                                ...
                                                @if ($product->compare_price > 0)
                                                    <span
                                                        class="h6 text-underline"><del>{{ number_format($product->compare_price,0) }} VND</del></span>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
