                ...
                <form action="" method="GET">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <div class="col-sm-6 text-right">
                                <a href="#" onclick="window.location.href='{{ route('coupons.index') }}'" class="btn btn-primary">Reset</a>
                            </div>
                        </div>
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            @if ($discountCoupons->isNotEmpty())
                                @foreach ($discountCoupons as $item)
                                    <tr>
                                        <td>{{ $item->id }}</td>
                                        <td>{{ $item->name }}</td>
                                        <td>{{ $item->code}}</td>
                                        ...
                                        <td>{{ \Carbon\Carbon::parse($item->starts_at)->format("d M ,Y")}}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" onclick="deleteCoupon({{$item->id}})"
