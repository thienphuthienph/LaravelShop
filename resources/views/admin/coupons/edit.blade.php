                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="max_uses" id="max_uses" value="{{$coupon->max_uses}}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="max_uses_user" id="max_uses_user" value="{{$coupon->max_uses_user}}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="discount_amount" id="discount_amount" value="{{$coupon->discount_amount}}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="min_amount" id="min_amount" value="{{$coupon->min_amount}}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="start_at" id="start_at"  value="{{$coupon->starts_at}}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="expire_at" id="expire_at" value="{{$coupon->expires_at}}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="type" id="type" class="form-control">
                                        <option {{($coupon->type == "percent") ? "selected" : ""}}  value="1">Percent</option>
                                        <option {{($coupon->type == "fixed") ? "selected" : ""}}  value="0">Fixed</option>
                                    </select>
                                </div>
                            </div>
                        </div>
